CREATE DATABASE  IF NOT EXISTS `scrt` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `scrt`;
-- MySQL dump 10.13  Distrib 5.6.17, for Win64 (x86_64)
--
-- Host: localhost    Database: scrt
-- ------------------------------------------------------
...
CREATE TABLE `servidor` (
  ...
  `EmpresaPropietaria` int(10) NOT NULL,
  PRIMARY KEY (`ID`)
...
-- Dump completed on 2014-11-25 20:03:00
